...
import com.nyl.enrollee.common.Dependent;
...
public class EnrollDependentService {
    //final static String ONEDEPENDENT_POSTURI = "http://localhost:8081/api/V1/dependent";
    //final static String DEPENDENTS_BYGROUPID_GETURI = "http://localhost:8081/api/V1/dependentsByGroupID/{gid}";
    //final static String DELETEDEPENDENT_POSTURI = "http://localhost:8081/api/V1/dependent/{id}";
    ...
    @Value("${enrollee.list.sort.column.default}")
    private String defaultSortColumn;

    @Value("{enrollee.onedependent.posturi}")
    private String ONEDEPENDENT_POSTURI;

    @Value("{enrollee.dependents.bygroupid.geturi}")
    private String DEPENDENTS_BYGROUPID_GETURI;

    @Value("{enrollee.deletedependent.posturi}")
    private String DELETEDEPENDENT_POSTURI;
